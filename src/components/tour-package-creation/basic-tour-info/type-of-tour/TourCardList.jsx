...
import AdventureTourCard from './AdventureTourCard';
import CultureTourCard from './CultureTourCard';
import HistoricalTourCard from './HistoricalTourCard';
import CulinaryTourCard from './CulinaryTourCard';
...
const TourCardList = () => {
  ...
  return (
    <div className="p-4 md:p-6 border-4 border-[#1D777D] rounded-lg mb-4">
      <div className="mb-4 text-xl font-semibold">
        <span>Type of Tour</span>
        <span className="text-red-500 ml-1">*</span>
      </div>

      <div className="flex flex-wrap space-y-4 md:flex-nowrap md:space-y-0 md:space-x-4 overflow-x-auto">
